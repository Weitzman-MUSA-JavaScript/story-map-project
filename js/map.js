...
map.on("load", function () {
  ...
  map.addSource('indonesia_boundary_source', {
    type: 'geojson',
    data: 'data/layers/indonesia_boundary.geojson'
  });
    // 1. your_line_layer (line)
    map.addLayer({
        id: "indonesia_boundary",
        type: "line",
        source: "indonesia_boundary_source",
        paint: {
            "line-color": "#000000", // this colours the line based on the colour attribute in the geojson
            "line-width": 4,
            "line-opacity": 0
        },
    });
  
    // 2. orangutan2016 (circle)
    map.addLayer({
        id: "orangutan2016",
        type: "circle",
        source: {
            type: "geojson",
            data: "data/layers/orangutan2016.geojson"
        },
        paint: {
    ...
    map.addLayer({
        ...
        source: {
            type: "geojson",
            data: "data/layers/emissions.geojson"
        },
        paint: {
            "fill-color": [
        'case',
        ['<', ['get', 'total_net'], -1000000], '#90d53b',
        ['<', ['get', 'total_net'], -500000], '#b6f071',
        ['<', ['get', 'total_net'], 0], '#f09471',
        ['<', ['get', 'total_net'], 500000], '#ee7a4e',
        ['<', ['get', 'total_net'], 1000000], '#e96735',
        ['<', ['get', 'total_net'], 10000000], '#e94709',
        '#880808' // Default color
    ],
          "fill-opacity": 0
        }
    });
  
    // 4. net_emissions (fill)
    map.addLayer({
      id: "net_emissions",
      type: "fill",
      source: {
          type: "geojson",
          data: "data/layers/net_emissions.geojson"
      },
      paint: {
          "fill-color": [
        'case',
    ...
    // 5. sequestration_country (fill)
    map.addLayer({
      id: "sequestration_country",
      type: "fill",
      source: {
          type: "geojson",
          data: "data/layers/sequestration_country.geojson"
      },
      paint: {
          "fill-color": [
        'case',
        ['>', ['get', 'total_removal'], 1000000000], '#2c6732',
        ['>', ['get', 'total_removal'], 500000000], '#3a7c40',
        ['>', ['get', 'total_removal'], 100000], '#6db774',
        ['>', ['get', 'total_removal'], 1000], '#8ad391',
        ['>', ['get', 'total_removal'], 0], '#aff4b6',
        '#ebeceb' // Default color
    ],
          "fill-opacity": 0
      }
  });  

    // 6. tree_loss_emission (fill)
    map.addLayer({
      id: "tree_loss_emission",
      type: "fill",
      source: {
          type: "geojson",
          data: "data/layers/tree_loss_emission.geojson"
      },
      paint: {
          "fill-color": [
        'case',
        ['>', ['get', 'total_emission'], 800000000], '#ce3214',
        ['>', ['get', 'total_emission'], 100000], '#f1684e',
        ['>', ['get', 'total_emission'], 1000], '#ef7963',
        ['>', ['get', 'total_emission'], 0], '#f39886',
        '#ebeceb' // Default color
    ],
          "fill-opacity": 0
      }

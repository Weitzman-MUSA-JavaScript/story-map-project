...
map.on("load", function () {
    ...
    map.addLayer({
        ...
        source: {
            type: "geojson",
            data: "data/layers/happycontours.geojson"
        },
        paint: {
    ...
    map.addLayer({
      ...
      source: {
          type: "geojson",
          data: "data/layers/fearcontours.geojson"
      },
      paint: {
    ...
    map.addLayer({
      ...
      source: {
          type: "geojson",
          data: "data/layers/unhappycontours.geojson"
      },
      paint: {
    ...
    map.addLayer({
       ...
       // 3. your_polygons_layer2 (fill)
    map.addLayer({
      id: "neighbourhood",
      type: "fill",
      source: {
          type: "geojson",
          data: "data/layers/surrounding.geojson"
      },
      paint: {
          "fill-color": '#90aba8', // Replace with the desired color
          "fill-opacity": 0
      }
    });
    ...
    map.addLayer({
      ...
      paint: {
          "fill-color": '#ab8084', // Replace with the desired color
          "fill-opacity": 0
      }
    });
    ...
    map.addLayer({
      ...
      source: {
          type: "geojson",
          data: "data/layers/barrack.geojson"
      },
      paint: {
          "fill-color": '#585858', // Replace with the desired color
          "fill-opacity": 0
      }
    });
    // 3. your_polygons_layer (fill)
    map.addLayer({
      ...
      source: {
          type: "geojson",
          data: "data/layers/Prague_1surrroundings.geojson"
      },
      paint: {
          "fill-color": '#6a6a6a', // Replace with the desired color
          "fill-opacity": 0
      }
    });
    ...
    scroller
      .setup({
        ...
        offset: 0.95, // an element is considered active when it is 75% in the viewport
